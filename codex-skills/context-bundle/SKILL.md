...
Run the bundled helper with Python 3.9 or newer, resolving the script relative
to this skill's installed directory:

```bash
python3 scripts/build_bundle.py --source /path/to/staging --output /path/to/context-bundle.zip
```
...
Deliver a clickable link to the single ZIP, its size, a brief description of
